...
const AddRect = () => {
  ...
  const handleInputChange = (e) => {
    ...
    const updatedValue = ["x", "y", "width", "height"].includes(name)
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${API_KEY}api/rect/`, elementData);
      const result = await response.data;
      console.log("Rect saved:", result);
      setLoading(false);
      Swal.fire({
        title: "Rect Added Successfully",
      ...
      console.error("Error saving Rect:", error);
      setLoading(false);
    }
  };
