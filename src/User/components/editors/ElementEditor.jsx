...
import SvgButtonWithRange from "../editors/opacityComponent";
...
const ElementEditor = ({ selectedElement, elements, setElements }) => {
  ...
  const handleChange = async (e) => {
    ...
    if (editedElement.type === "GroupLayout") {
      if (name === "padding") {
        updatedValue = [updatedValue, updatedValue, updatedValue, updatedValue];
      }
    }
        ...
        return (
          <div className="flex flex-wrap gap-2">
            <div className="flex flex-col justify-center">
              ...
              <select
                name="orientatio"
                value={editedElement.orientatio}
                onChange={handleChange}
                className="border text-xs rounded-lg px-[5px] py-[5px] w-[100px]"
              >
            ...
            <div className="flex flex-col justify-center">
              <label className="block text-xs text-transparent">Padding</label>
              <div className="flex items-center space-x-1 border rounded-lg px-[3px]">
                <button
                  type="button"
                  onClick={() =>
                    handleChange({
                      target: {
                        name: "padding",
                        value: editedElement.padding[0] - 1,
                      },
                    })
                  }
                  className="bg-transparent text-lg"
